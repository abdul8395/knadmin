...
<div class="tabset" style="
  ...
  <label for="tab2" style="color:#fff">Register Admin</label>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ 'Your password must be more than 8 characters long, should contain at-least 1 Uppercase, 1 Lowercase And 1 Numeric.' }}</strong>
                                            </span>
                                        @enderror
                                    </div>
                                </div>
