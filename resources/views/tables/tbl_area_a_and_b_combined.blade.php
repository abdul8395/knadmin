...
@section('content')
    ...
    <input type="hidden" id="hidden_table_name"  value="tbl_area_a_and_b_combined">
 <!--Insert  Modal -->
        ...
        <div class="modal-dialog" style="width:60%;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class=" btn btn-success" onclick="insert_tbl_area_a_and_b_combined()" id="updatedata" style="color:white;">Insert</button>
