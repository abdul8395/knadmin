...
@section('content')
    ...
    <input type="hidden" id="hidden_table_name"  value="tbl_expropriation_orders">
 <!--Insert  Modal -->
    ...
    <div class="modal-dialog" style="width:60%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" id="ins_reason"  name="reason" required>
                        </div>
                        <div class="form-group">
                        <label for="email">title:</label>
                        <input type="text" class="form-control" id="ins_title"  name="title" required>
                        </div>
                        <div class="form-group">
                        <label for="email">sign_date:</label>
                        <input type="date" class="form-control" id="ins_sign_date"  name="sign_date" required>
                        </div>
                        <div class="form-group">
                        <label for="email">District:</label>
                        <input type="number" class="form-control" id="ins_district"  name="sign_date" required>
                        </div>
                        <div class="form-group">
                        <label for="email">remark:</label>
                        <input type="text" class="form-control" id="ins_remark"  name="remark" required>
                        </div>
                        <div class="form-group">
                        <label for="email">created_us:</label>
                        <input type="text" class="form-control" id="ins_created_us"  name="created_us" required>
                        </div>
                        <div class="form-group">
                        <label for="email">created_da:</label>
                        <input type="date" class="form-control" id="ins_created_da"  name="created_da" required>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" id="ins_last_edite"  name="last_edite" required>
                        </div>
                        <div class="form-group">
                        <label for="email">last_edi_1:</label>
                        <input type="date" class="form-control" id="ins_last_edi_1"  name="last_edi_1" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class=" btn btn-success" onclick="insert_tbl_expropriation_orders()" id="updatedata" style="color:white;">Insert</button>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                        <label for="email">reason:</label>
                        <input type="number" class="form-control" id="reason"  name="reason" required>
                        </div>
                        <div class="form-group">
                        <label for="email">title:</label>
                        ...
                        <div class="form-group">
                        <label for="email">District:</label>
                        <input type="number" class="form-control" id="district"  name="sign_date" required>
                        </div>
                        <div class="form-group">
                        <label for="email">remark:</label>
                        ...
                        <div class="form-group">
                        <label for="email">created_da:</label>
                        <input type="date" class="form-control" id="created_da"  name="created_da" required>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                        <label for="email">last_edite:</label>
                        <input type="text" class="form-control" id="last_edite"  name="last_edite" required>
                        </div>
                        <div class="form-group">
                        <label for="email">last_edi_1:</label>
                        <input type="date" class="form-control" id="last_edi_1"  name="last_edi_1" required>
                        </div>
                        <div class="form-group">
                        <label for="email">shape_leng:</label>
