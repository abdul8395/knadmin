    ...
    @foreach ($tbldata as $p)
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" id="hidnfid" />   
                    <input type="button" class="btn btn-warning"  value="Edit" onclick="editbtn_tbl_expropriation_orders({{$p->fid}})" />    
                    <input type="button" class="btn btn-danger" style="margin-top: 2px !important;" value="Delete" onclick="deletebtn_tbl_expropriation_orders({{$p->fid}})" />    
                </td>
            </tr>
    @endforeach
